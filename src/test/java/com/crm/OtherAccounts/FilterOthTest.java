...
public class FilterOthTest extends BaseTest {
    ...
    public void signIn(String username, String password) {
        ...
        super.driver.get("http://crm-dash/other-accounts");

        WebElement select = wait
                .until(ExpectedConditions.visibilityOfElementLocated(By.name("other-accounts-list_length")));

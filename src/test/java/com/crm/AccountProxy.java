...
public class AccountProxy {
 ...
 @Test(dataProvider = "FarmerGlobalCredentials", dataProviderClass = CredentialsProvider.class)
    ...
    // Export csv
        // Delete proxy
        WebElement proxyCheckbox = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/main/div[2]/div/div/div/div[2]/div[2]/div/div/div/div[3]/div[2]/table/tbody/tr/td[1]/div/input")));
        proxyCheckbox.click();

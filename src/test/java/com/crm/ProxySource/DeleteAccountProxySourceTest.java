...
public class DeleteAccountProxySourceTest extends BaseTest {
    ...
    public void signIn(String username, String password) {
        ...
        Helpers.waitForSeconds(3);
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("#account-proxy-sources tbody tr:first-child td:first-child"))).click();
        Helpers.waitForSeconds(3);
        wait.until(ExpectedConditions.elementToBeClickable(By.id("delete-dt-row"))).click();
        Helpers.waitForSeconds(3);
        wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.swal2-confirm"))).click();
        Helpers.waitForSeconds(3);

        boolean isButtonGone = wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("button.swal2-confirm")));

        Assert.assertTrue(isButtonGone);

        Reporter.log("AutomatedAccountProxySource a fost sters cu success!", true);

...
public class CreateGoogleAccount {
    ...
    public void signIn(String username, String password) {
        ...
        Helpers.waitForSeconds(3);
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("input.form-control[type='search']"))).sendKeys("GoogleAccountNameTestJava");
    ...
    private void fillFormFields() {
        ...
        enterText(By.cssSelector("input.form-control.js-maxlength[name='2fa'][data-modal-field-id='create_2fa']"),
        ...
        handleAutocomplete(By.cssSelector(
                "input.form-control.js-maxlength[inputname='source_id'][data-modal-field-id='create_source_id']"), "FJ",
